...
`define  FXD_POINT_COEFF (1 << 15)
   ...
   class basic_sequence_item # (
      ...
      logic [COEFF_WIDTH-1:0]            coeff_x_i [0:INPUT_TAPS-1] = '{ logic'(1.0 * `FXD_POINT_COEFF),
                                                                         logic'(1.8836532429909993 * `FXD_POINT_COEFF),
                                                                         logic'(0.8900591334898765 * `FXD_POINT_COEFF)};
      
	    logic [COEFF_WIDTH-1:0] coeff_y_i [0:OUTPUT_TAPS-1] = '{ logic '(1.8836532429909993 * `FXD_POINT_COEFF),
                                                               logic '(0.8900591334898765 * `FXD_POINT_COEFF)};
